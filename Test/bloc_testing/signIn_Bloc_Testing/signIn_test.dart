...
import 'package:coin_ease/bloc/signin_bloc/sign_in_bloc.dart'; // Import your SignInBloc
  ...
  group('SignInBloc', () {
    ...
    test('Emits SignInSuccess for correct password', () {
      final correctPassword =
          'correct_password'; // Replace with the correct password
    ...
    test('Emits SignInFailure for incorrect password', () {
      final incorrectPassword =
          'incorrect_password'; // Replace with an incorrect password
      final expectedStates = [
        SignInLoading(),
