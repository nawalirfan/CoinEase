...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Transaction_Repository transactionRepository = Transaction_Repository();
    var countrycode;
    var phone;
    return MultiBlocProvider(
        ...
        child: MaterialApp(
            ...
            darkTheme: ThemeData.dark().copyWith(
              primaryColor:
                  AppColors.primaryColor, // You can customize this color
            ...
            routes: {
              ...
              '/Phone_verification': (BuildContext context) =>
                  const PhoneVerification(),
              '/OtpPin': (BuildContext context) =>
                  OtpPin(phoneNumber: countrycode.text + phone),
              '/SignUp': (BuildContext context) => const SignUpDetails(
                    phoneNumber: '',
                  ),
